...
const WetPaint = () => {
  return (
    <div className="relative rounded-md bg-primary px-5 py-2 font-extrabold text-white">
      ...
      <div className="z-20 absolute box-border left-[20%] rounded-b-full origin-top bottom-3 ">
      ...
      <div className="z-20 absolute box-border left-[50%] rounded-full origin-top bottom-0  ">
